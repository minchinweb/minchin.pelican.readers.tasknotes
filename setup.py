...
#                          PACKAGE METADATA                                  #
##############################################################################
META_PATH = ["minchin", "pelican", "readers", "tasknotes", "constants.py"]
...
setuptools.setup(
    ...
    url=URL,
    project_urls={
        "Bug Tracker": "https://github.com/MinchinWeb/minchin.pelican.tasknotes.microblog/issues",
        "Changelog": "https://github.com/MinchinWeb/minchin.pelican.tasknotes.microblog/blob/master/CHANGELOG.rst",
    },
    license=LICENSE,
    author=AUTHOR,
